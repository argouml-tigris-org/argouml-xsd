...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="niematron:fxnGetDataType">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$vAttributeRootNode/UML:StructuralFeature.type[1]/UML:Enumeration">
                ...
                <xsl:value-of
                    select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Enumeration[@xmi.id=$vEnumType]/@name"
                />
            </xsl:when>
            ...
            <xsl:when
                ...
                <xsl:value-of
                    select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:DataType[@xmi.id=$vDataType]/@name"
                />
            </xsl:when>
    ...
    <xsl:template name="niematron:fxnGetClassAttributes">
        ...
        <xsl:for-each
            ...
            <xsl:element name="xsd:attribute">
                ...
                <xsl:if
                    test="./UML:StructuralFeature.multiplicity[1]/UML:Multiplicity[1]/UML:Multiplicity.range[1]/UML:MultiplicityRange[@lower = 0]">
                    <xsl:attribute name="use">
    ...
    <xsl:template name="niematron:fxnGetClassElements">
        ...
        <xsl:for-each
            select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Association">
            <xsl:for-each
                ...
                <xsl:element name="xsd:element">
                    <xsl:choose>
                        ...
                        <xsl:when
                            test="count(/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Class[@xmi.id = $vToClassIdref]) > 0">
                            <xsl:attribute name="ref">
                                <xsl:value-of
                                    select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Class[@xmi.id = $vToClassIdref]/@name"
                                />
                            </xsl:attribute>
                        </xsl:when>
                        ...
                        <xsl:when
                            test="count(/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Interface[@xmi.id = $vToInterfaceIdref]) > 0">
                            <xsl:attribute name="ref">
                                <xsl:value-of
                                    select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Interface[@xmi.id = $vToInterfaceIdref]/@name"
                                />
                            </xsl:attribute>
                        </xsl:when>
                    </xsl:choose>
                ...
                <xsl:element name="xsd:element">
                    <xsl:choose>
                        ...
                        <xsl:when test="string-length(../../@name) > 0">
                            ...
                            <xsl:attribute name="type">
                                <xsl:value-of
                                    select="concat(/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Class[@xmi.id = $vToClassIdref]/@name, 'Type')"
                                />
                            </xsl:attribute>
                        </xsl:when>
                    ...
                    <xsl:attribute name="minOccurs">
                        ...
                        <xsl:choose>
                            <xsl:when test="../UML:AssociationEnd[@isNavigable='true']/UML:AssociationEnd.multiplicity[1]/UML:Multiplicity[1]/UML:Multiplicity.range[1]/UML:MultiplicityRange[1]/@lower">
                            <xsl:value-of
                                select="../UML:AssociationEnd[@isNavigable='true']/UML:AssociationEnd.multiplicity[1]/UML:Multiplicity[1]/UML:Multiplicity.range[1]/UML:MultiplicityRange[1]/@lower"
                            />
                            </xsl:when>
    ...
    <xsl:template match="*">
        ...
        <xsl:choose>
            <xsl:when
                test="/uml/XMI/@xmi.version != '1.2' or /uml/XMI/XMI.header/XMI.metamodel/@xmi.version !='1.4'">
...
- UML version 1.4 encpasulated in XMI version 1.2. 
            ...
            <xsl:otherwise>
                ...
                <xsl:variable name="vDocumentTagId"
                    select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:TagDefinition[1]/@xmi.id"/>

                <xsl:element name="xsd:schema">
                    <!-- Annotation for the file comes from the Model description tag. -->
                    <xsl:for-each
                        select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:ModelElement.taggedValue/UML:TaggedValue[./UML:TaggedValue.type/UML:TagDefinition/@xmi.idref = $vDocumentTagId]">
                        <xsd:annotation>
                            <xsd:documentation>
                    ...
                    <xsl:for-each
                        select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement/UML:Class">
                                        ...
                                        <xsl:element name="xsd:extension">
                                            <xsl:attribute name="base">
                                                ...
                                                <xsl:variable name="vParentIdRef"
                                                  select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Generalization[@xmi.id = $vGeneralizationRef]/UML:Generalization.parent[1]/UML:Class[1]/@xmi.idref"/>
                                                <xsl:value-of
                                                  select="concat(/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Class[@xmi.id = $vParentIdRef]/@name, 'Type')"
                                                />
                                            </xsl:attribute>
                    ...
                    <xsl:if
                        test="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Interface">
                        <xsl:text>
                    ...
                    <xsl:for-each
                        select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Interface">
                    ...
                    <xsl:variable name="vRealizeStereotype"
                        select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Stereotype[@name='realize']/@xmi.id"/>
                    <xsl:for-each
                        select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Class">
                        ...
                        <xsl:element name="xsd:element">
                            ...
                            <xsl:if
                                test="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Abstraction[@xmi.id=$vClassAbstrRef]/UML:ModelElement.stereotype[1]/UML:Stereotype/@xmi.idref = $vRealizeStereotype">
                                <xsl:variable name="vAbstractRef"
                                    select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Abstraction[@xmi.id=$vClassAbstrRef]/UML:Dependency.supplier/UML:Interface/@xmi.idref"/>
                                <xsl:attribute name="substitutionGroup">
                                    <xsl:value-of
                                        select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Interface[@xmi.id=$vAbstractRef]/@name"
                                    />
                                </xsl:attribute>
                            </xsl:if>
                        </xsl:element>
                    ...
                    <!-- Enumerations -->
                    <xsl:if
                        test="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Enumeration">
                        <xsl:text>
                    ...
                    <xsl:for-each
                        select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:Enumeration">
                    ...
                    <xsl:if
                        test="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:DataType">
                        <xsl:text>
                    ...
                    <xsl:for-each
                        select="/uml/XMI/XMI.content[1]/UML:Model[1]/UML:Namespace.ownedElement[1]/UML:DataType">
                        <xsl:element name="xsd:simpleType">
                            <xsl:attribute name="name">
                                <xsl:value-of select="@name"/>
                            </xsl:attribute>
